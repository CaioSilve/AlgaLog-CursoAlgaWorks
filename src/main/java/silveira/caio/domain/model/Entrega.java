...
public class Entrega {
	...
	//Embute os campos de destinatario na tabela entrega
	@Embedded
	...
	public Ocorrencia addOcorrencia(String descricao) {
		...
		oco.setDescricao(descricao);
		oco.setDataRegistro(OffsetDateTime.now());
		oco.setEntrega(this);
		
		this.getOcorrencias().add(oco);
	...
	public void finalizar() {
		if(!StatusEntrega.PENDENTE.equals(getStatus())){
			throw new ServiceException("Não pode ser finalizada");
		}
